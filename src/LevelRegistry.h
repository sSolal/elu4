...
// the menu's "Start game" button and by engine.goto_scene() transitions. `save`
// is the persistent state the scene reads/writes via engine.save_get/save_set
// (non-owning; the runner owns it). Pass nullptr to run a scene without saving.
